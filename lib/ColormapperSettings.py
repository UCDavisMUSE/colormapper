...
class ColormapperSettings:
    ...
    def __init__(self, unmix = unmix, remix = remix):
        self.unmix = unmix
        self.remix = remix
        self.contrastValues = np.linspace(self.remix["contrastValuesStart"],
    ...
    def GetRemixBackgroundBrightnessSetting
